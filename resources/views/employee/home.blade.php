    ...
    @php
        ...
        $leadsGenerated = DB::table(function ($query) use ($emp_id) {
            $query
                ...
                ->where('iEnterBy', Auth::guard('web_employees')->user()->emp_id)
        ...
        // Fill zero for missing months (1 to 12)
        ...
        <div class="page-content">
            <div class="container mb-5">
                ...
                <div class="row g-3 mb-4 text-white">
                    <div class="col-md-4">
                        <a href="{{ route('employee.todays_followup') }}">
                    ...
                    <!-- Overdue Followup -->
                    <div class="col-md-4">
                        <a href="{{ route('employee.over_due_followup') }}">
                    ...
                    @foreach ($piplines as $pipline)
                        <div class="col-md-4">
                            ...
                            @endphp
                            <a href="{{ route('employee.status', $slug) }}">
                                {{--  @endif  --}}

                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body border-bottom">
                                <form action="{{ route('employee.todays_followup') }}" method="POST" class="row g-3 align-items-end">
                                    @csrf
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="{{ route('employee.todays_followup') }}" class="btn btn-secondary">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse($paginated as $index => $lead)
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('employee.followup_detail', ['todays-followup', $lead->lead_id]) }}"

...
@section('title', 'Add Performa Invoice')
...
<div class="main-content">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <h5 class="mb-sm-0">Add Performa Invoice
        ...
        <div class="live-preview">
            ...
            <form method="POST" action="{{ route('performainvoice.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            <span style="color:red;">*</span>Performa Invoice No</label>
                            <input class="form-control" id="basic-form-name" name="iPerformaInvoiceNo" type="text"
                                   placeholder="Enter Invoice No" value="{{ old('iPerformaInvoiceNo') }}" readonly>

                        </div>

                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            <span style="color:red;"></span>Invoice Validity</label>
                            <input class="form-control" id="basic-form-name" name="invoiceValidity" type="text"
                                placeholder="Enter Invoice Validity" value="{{ old('invoiceValidity') }}">
                        </div>
                ...
                <div class="card-footer">
                    ...
                    <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('performainvoice.index') }}">Cancel</a>
                </div>
            </form>
            </div>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.full.min.js"></script>
    ...
    <script>
        ...
        function mapping() {
            ...
            //alert(company);
            var url = "{{ route('performainvoice.mapping', ':company') }}";
    ...
    <script>
        function termconditionFetch() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('performainvoice.termconditionFetch') }}",
                data: {
...
+                                });
    ...
    function setInvoiceNo() {
      if (!COMPANY_ID) {
        $('input[name="iPerformaInvoiceNo"]').val('');
        return;
      }
      $.ajax({
        url: "{{ route('performainvoice.getNextNo', ':companyId') }}".replace(':companyId', COMPANY_ID),
        type: 'GET',
        success: function (data) {
            console.log(data);
          $('input[name="iPerformaInvoiceNo"]').val(data);
        },

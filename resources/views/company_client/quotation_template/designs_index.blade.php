...
<div class="container-fluid">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <!-- <a href="{{ route('quotations.templates.create') }}" class="btn btn-primary">Upload Template</a> -->
  </div>
        ...
        <div class="card h-100 {{ $tpl->guid === $currentDefaultGuid ? 'border-success' : '' }}">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <form method="POST" action="{{ route('quotations.templates.default', $tpl) }}">
                @csrf @method('PATCH')
                <input type="radio"
            ...
            @if($latestQuotation)
                <a href="{{ route('quotations.templates.preview', [$tpl->id, $latestQuotation->quotationId]) }}"
           ...
           <!--  <form action="{{ route('quotations.templates.toggle', $tpl) }}" method="post" class="d-inline">
              @csrf @method('PATCH')
            ...
            <form action="{{ route('quotations.templates.destroy', $tpl) }}" method="post" class="d-inline"

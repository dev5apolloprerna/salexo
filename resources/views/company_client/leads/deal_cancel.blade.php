                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form method="GET" action="{{ route('leads.cancel') }}" id="myForm">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th width="3%">Lead Cancel Date</th>
                                                                            <th width="4%">Lead Cancel Reason</th>
                                                                        ...
                                                                        @forelse($leads as $index => $lead)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <a href="{{ route('leads.lead_history', ['status' => 'lead-cancel', 'lead_id' => $lead->lead_id]) }}"
                                                                                        title="History">
                                                                                        <i class="fa fa-eye"
                                                                                            aria-hidden="true"></i>
                                                                                    </a>
                                                                                    ...
                                                                                    @if (Auth::user()->isCompanyAdmin == 1)
                                                                                        <a href="{{ route('clients.followup_detail', ['lead-cancel', $lead->lead_id]) }}"
                                                                                            title="Add Followup">

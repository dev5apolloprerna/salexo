...
<div class="main-content">
  ...
  <form method="post" action="{{ route('admin.invoice.templates.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{ route('admin.invoice.templates') }}" class="btn btn-light">Cancel</a>
  </form>
</div>
</div>
</div>

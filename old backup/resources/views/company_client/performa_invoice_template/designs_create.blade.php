...
<div class="main-content">
  ...
  <form method="post" action="{{ route('performainvoiceT.templates.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{ route('performainvoiceT.templates') }}" class="btn btn-light">Cancel</a>
  </form>
</div>
</div>
</div>

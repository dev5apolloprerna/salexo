            ...
            <form method="POST" action="{{ route('invoice.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            <span style="color:red;">*</span>Invoice No</label>
                            <input class="form-control" id="basic-form-name" name="iInvoiceNo" type="text"
                                   placeholder="Enter Invoice No" value="{{ old('iInvoiceNo') }}" readonly>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.full.min.js"></script>
    ...
    <script>
        function termconditionFetch() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('invoice.termconditionFetch') }}",
                data: {

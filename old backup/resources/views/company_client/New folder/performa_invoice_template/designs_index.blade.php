        ...
        <div class="card h-100 {{ $tpl->guid === $currentDefaultGuid ? 'border-success' : '' }}">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <form method="POST" action="{{ route('performainvoiceT.templates.default', $tpl) }}">
                @csrf @method('PATCH')
                <input type="radio"
            ...
            @if($latestQuotation)
                <a href="{{ route('performainvoiceT.templates.preview', [$tpl->id, $latestQuotation->invoiceId]) }}"
           ...
           <!--  <form action="{{ route('performainvoiceT.templates.toggle', $tpl) }}" method="post" class="d-inline">
              @csrf @method('PATCH')
            ...
            <form action="{{ route('performainvoiceT.templates.destroy', $tpl) }}" method="post" class="d-inline"

...
@section('title', 'Lead Given Detail List')
@section('content')
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5 class="card-title mb-0">
                                    Lead Given Detail List – <span class="text-primary">{{ $employee->emp_name }}</span>
                                </h5>

                                <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm "
                                    href="{{ route('clients.reports.emp_performance') }}">Back</a>
                            </div>
                            @if($fromDate && $toDate)

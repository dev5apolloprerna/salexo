            ...
            <div class="row mb-4">
                ...
                @if($status == "over-due")
                    <div class="col-12 mb-3 d-flex justify-content-end">
                        <a href="{{ route('clients.over_due_followup') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            Back
                        </a>
                    </div>
                @elseif($status == "todays-followup")
                    <div class="col-12 mb-3 d-flex justify-content-end">
                        <a href="{{ route('clients.todays_followup') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            Back
                        </a>
                    </div>
                @else
                    <div class="col-12 mb-3 d-flex justify-content-end">
                        <a href="{{ route('clients.new_lead',$status) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            Back
                        </a>
                    </div>
                @endif
                                ...
                                <table class="table table-bordered table-striped table-hover datatable">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th>Status</th>
                                            <th>Comment</th>
                                            @if (!in_array($status, ['deal-done', 'todays-followup', 'over-due']))
                                            <th>Reason</th>
                                            @endif
                                            <th>Amount</th>

...
<div class="main-content">
  ...
  <form method="post" action="{{ route('admin.performa_invoice.templates.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{ route('admin.performa_invoice.templates') }}" class="btn btn-light">Cancel</a>
  </form>
</div>
</div>
</div>

...
class AdminPerformaInvoiceTemplateController extends Controller
{
   public function index(Request $request)
    {
        ...
        $templates = PerformaInvoiceTemplate::orderByDesc('id')->get();
        ...
        return view('admin.performa_template.designs_index', compact('templates','currentDefaultGuid'));
    }

    public function create()
    {
        return view('admin.performa_template.designs_create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $baseDir = public_path("performa_invoice_templates/{$guid}");
        ...
        $relativePath = "performa_invoice_templates/{$guid}/{$name}";

        PerformaInvoiceTemplate::create([
            'guid'       => $guid,
            'name'       => $request->name,
        ...
        return redirect()->route('admin.performa_invoice.templates')
    ...
    public function setDefault(PerformaInvoiceTemplate $template)
    {
        ...
        DB::table('company_client_master')
            ->where('company_id', $companyId)
            ->update(['performa_invoice_templates' => $valueToStore]);

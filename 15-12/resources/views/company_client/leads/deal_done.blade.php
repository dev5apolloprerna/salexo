                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form method="GET" action="{{ route('leads.done') }}" id="myForm">
                                                    <input type="hidden" name="lead_type" id="lead_type" value="deal_done">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                                    ...
                                                                    <tbody>
                                                                        @forelse($leads as $index => $lead)
                                                                            <tr class="text-center">
                                                                                ...
                                                                                <!--<td>-->
                                                                                <!--    {{ $lead->leadSource->lead_source_name ?? '' }}-->
                                                                                <!--</td>-->
                                                                                <td>
                                                                                ...
                                                                                <td>{{ $lead->amount ?? '-' }}</td>
                                                                                <td>
                                                                                    <a href="{{ route('leads.lead_history', ['status' => 'lead-done', 'lead_id' => $lead->lead_id]) }}"
                                                                                        title="History">
                                                                                        <i class="fa fa-eye"
                                                                                            aria-hidden="true"></i>
                                                                                    </a>

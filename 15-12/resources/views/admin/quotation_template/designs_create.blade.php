...
<div class="main-content">
  ...
  <form method="post" action="{{ route('admin.quotations.templates.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <a href="{{ route('admin.quotations.templates') }}" class="btn btn-light">Cancel</a>
  </form>
</div>
</div>
</div>

...
use App\Http\Controllers\Api\PerformaInvoiceTemplateApiController;
use App\Http\Controllers\Api\PerformaInvoicePdfController;
...
Route::prefix('employee')->group(function () {
    ...
    Route::middleware(['auth:employee_api'])->group(function () {
        ...
        Route::prefix('invoice')->group(function () {
            Route::post('/',              [InvoiceApiController::class, 'index'])->name('api.invoice.index');
            Route::post('/next-number',   [InvoiceApiController::class, 'getNextInvoiceNo'])->name('api.invoice.next');
            Route::post('/create',       [InvoiceApiController::class, 'store'])->name('api.invoice.store');
            Route::post('/{id}/show',          [InvoiceApiController::class, 'show'])->name('api.invoice.show');
            Route::post('/{id}/update',          [InvoiceApiController::class, 'update'])->name('api.invoice.update');
            Route::post('/{id}/delete',       [InvoiceApiController::class, 'destroy'])->name('api.invoice.destroy');

            Route::post('/{id}/details',  [InvoiceApiController::class, 'details'])->name('api.invoice.details');
            // Route::post('/{id}/pdf',      [InvoiceApiController::class, 'pdf'])->name('api.invoice.pdf');
            Route::post('/{id}/copy',    [InvoiceApiController::class, 'copy'])->name('api.invoice.copy');
            Route::post('/{id}/send-whatsapp', [InvoiceApiController::class, 'sendWhatsApp'])->name('api.invoice.whatsapp');
        });
    
            //invoice detail
                 Route::post('/invoice-detail/list', [InvoiceDetailApiController::class, 'index']);
                Route::post('/invoice-detail/create', [InvoiceDetailApiController::class, 'store']);

                // Single detail by id
                Route::post('/invoice-detail/productshow',  [InvoiceDetailApiController::class, 'productshow']);
                Route::post('/invoice-detail/update',  [InvoiceDetailApiController::class, 'update']);
                Route::post('/invoice-detail/delete',  [InvoiceDetailApiController::class, 'destroy']);
              ...
              //performa invoice start
                ...
                Route::post('/next-number',   [PerformaInvoiceApiController::class, 'getNextInvoiceNo'])->name('api.performa_invoice.next');
                Route::post('/create',       [PerformaInvoiceApiController::class, 'store'])->name('api.performa_invoice.store');
                Route::post('/{id}/show',          [PerformaInvoiceApiController::class, 'show'])->name('api.performa_invoice.show');
                Route::post('/{id}/update',          [PerformaInvoiceApiController::class, 'update'])->name('api.performa_invoice.update');
                Route::post('/{id}/delete',       [PerformaInvoiceApiController::class, 'destroy'])->name('api.performa_invoice.destroy');

                    Route::post('/{id}/details',  [PerformaInvoiceApiController::class, 'details'])->name('api.performa_invoice.details');
                    // Route::post('/{id}/pdf',      [PerformaInvoiceApiController::class, 'pdf'])->name('api.invoice.pdf');
                    Route::post('/{id}/copy',    [PerformaInvoiceApiController::class, 'copy'])->name('api.performa_invoice.copy');
                    Route::post('/{id}/send-whatsapp', [PerformaInvoiceApiController::class, 'sendWhatsApp'])->name('api.performa_invoice.whatsapp');
                });

                //invoice detail
                 Route::post('/performa-invoice-detail/list', [PerformaInvoiceDetailApiController::class, 'index']);
                Route::post('/performa-invoice-detail/create', [PerformaInvoiceDetailApiController::class, 'store']);

                // Single detail by id
                Route::post('/performa-invoice-detail/productshow',  [PerformaInvoiceDetailApiController::class, 'productshow']);
                Route::post('/performa-invoice-detail/update',  [PerformaInvoiceDetailApiController::class, 'update']);
                Route::post('/performa-invoice-detail/delete',  [PerformaInvoiceDetailApiController::class, 'destroy']);

   ...
   public function index(Request $request)
    {
        ...
        $templates = InvoiceTemplate::orderByDesc('id')->get();
        ...
        return view('admin.invoice_template.designs_index', compact('templates','currentDefaultGuid'));
    }

    public function create()
    {
        return view('admin.invoice_template.designs_create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $baseDir = public_path("Invoice_templates/{$guid}");
        ...
        $relativePath = "Invoice_templates/{$guid}/{$name}";
        ...
        return redirect()->route('admin.invoice.templates')

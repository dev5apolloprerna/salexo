                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0">Invoice List
                                    <a href="{{ route('invoice.create') }}" style="float: right;"
                                        class="btn btn-sm btn-primary">
                                        <i class="far fa-plus"></i> Add Invoice
                                    </a>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        ...
                                        <?php
                                            $product=App\Models\InvoiceDetail::where('invoiceId', $inv->invoiceId)->count();
                                        ?>
                                        @if(($product) > 0)
                                            <a href="{{ route('invoice.DetailPDF', $inv->invoiceId) }}" class="m-2" title="Download">
                                        ...
                                        @endif
                                           ...
                                           @php
                                            ...
                                            <a href="{{ route('invoice.copy', $inv->invoiceId) }}" title="Copy"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{ route('invoice.delete', $inv->invoiceId ?? '') }}" id="user-delete-form"
                            method="POST">
                            @csrf
                            @method('DELETE')
